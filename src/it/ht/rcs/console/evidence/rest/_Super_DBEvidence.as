...
internal class _Super_DBEvidence extends com.adobe.fiber.services.wrapper.HTTPServiceWrapper
{
    ...
    public function _Super_DBEvidence()
    {
        ...
        operation.resultType = it.ht.rcs.console.evidence.model.FileSystemSearchResult;
         ...
         operation = new mx.rpc.http.Operation(null, "command_");
         operation.url = "/evidence/command/{id}";
         operation.method = "GET";
         argsArray = new Array("id","target_id");
         operation.argumentNames = argsArray;         
         operation.serializationFilter = serializer0;
         operation.properties = new Object();
         operation.properties["urlParamNames"] = ["id"];
    ...
    /**
      * This method is a generated wrapper used to call the 'command_' operation. It returns an mx.rpc.AsyncToken whose
      * result property will be populated with the result of the operation when the server response is received.
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value.
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function command_(id:String, target_id:String) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("command_");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(id,target_id) ;
        return _internal_token;
    }
